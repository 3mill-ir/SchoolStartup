...
var Main = function () {
    ...
    var settingsHandler = function () {
        ...
        $('#skin_color').attr("href", "../../Content/AdminContent/assets/css/themes/" + appSetting.theme + ".css");
        ...
        $('input[name="setting-theme"]').change(function () {
            ...
            $('#skin_color').attr("href", "../../Content/AdminContent/assets/css/themes/" + selectedTheme + ".css");
        ...
        function switchLogo(theme) {
            switch (theme) {
                ...
                case "theme-5":
                case "theme-6":
                    $(".navbar-brand img").attr("src", "/Content/AdminContent/assets/images/logo2.png");
                    break;

                default:
                    $(".navbar-brand img").attr("src", "/Content/AdminContent/assets/images/logo.png");
                    break;
            };
        };
        function defaultSetting() {
            ...
            //$('#skin_color').attr("href", "/Content/AdminContent/assets/css/themes/theme-1.css");
            $('#skin_color').attr("href", "/Content/AdminContent/assets/css/themes/theme-5.css");
            $(".navbar-brand img").attr("src", "/Content/AdminContent/assets/images/logo.png");
