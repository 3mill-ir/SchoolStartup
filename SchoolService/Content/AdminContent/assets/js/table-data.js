var TableData = function() {
	...
	var runDataTable_example1 = function() {
		...
		$('#sample_1_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "جستجو...");
	...
	var runDataTable_example2 = function() {
		...
		$('#sample_2_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "جستجو...");
		// modify table search input
