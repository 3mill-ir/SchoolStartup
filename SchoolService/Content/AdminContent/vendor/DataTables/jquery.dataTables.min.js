...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"هیچ داده ای در جدول وجود ندارد !",sInfo:"نمایش ابتدا تا انتهای تمام ورودی ها",sInfoEmpty:"نمایش 0 تا 0 از 0 ورودی",sInfoFiltered:"(فیلتر شده از _MAX_ ورودی)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"بارگذاری...",sProcessing:"در حال پردازش...",sSearch:"جست و جو :",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"چنین رکوردی وجود ندارد !"},oSearch:h.extend({},
